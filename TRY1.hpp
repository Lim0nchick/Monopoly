...
unsigned int try1p(unsigned short d, unsigned int points,
	unsigned short CurPos, unsigned n,
...
unsigned int try2p(unsigned short d1, unsigned short d2, unsigned n,
...
unsigned int try3p(unsigned short d1, unsigned short d2,
 unsigned short d3,  unsigned n,
 unsigned int points, unsigned short CurPos,
 unsigned short* field, list<pair<unsigned short, unsigned>> lChance)	
{
